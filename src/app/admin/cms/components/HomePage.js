export default function HomePage({ formData, handleChange, handleFileChange, handleSubmit }) {
  return (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              type="file"
              accept="image/*"
              onChange={(e) => handleFileChange(e, "bannerSection", "bannerImage")}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleChange(e, "jobCategorySection", "description")}
            />
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleChange(e, "secondBannerSection", "description")}
            />
          </div>
          <div>
            <p className="mb-2 font-medium">Upload Banner Image</p>
            <input
              type="file"
              accept="image/*"
              onChange={(e) => handleFileChange(e, "secondBannerSection", "bannerImage")}
              className="w-full p-2 border rounded-lg bg-[#0B2447] text-white"
            />
          </div>
        </div>
